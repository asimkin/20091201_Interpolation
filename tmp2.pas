unit tmp2;
 { Модуль расширенной работы с массивами, для Spline.pas }
interface
...
type
    ...
    TInteger2Array     = array of array of LongInt;
...
function DynamicArrayCopy(const A: TIntegerArray):TIntegerArray;overload;
function DynamicArrayCopy(const A: TDoubleArray):TDoubleArray;overload;
function DynamicArrayCopy(const A: TComplex1DArray):TComplex1DArray;overload;
function DynamicArrayCopy(const A: TBooleanArray):TBooleanArray;overload;

function DynamicArrayCopy(const A: TInteger2Array):TInteger2Array;overload;
function DynamicArrayCopy(const A: TDouble2Array):TDouble2Array;overload;
function DynamicArrayCopy(const A: TComplex2DArray):TComplex2DArray;overload;
function DynamicArrayCopy(const A: TBoolean2Array):TBoolean2Array;overload;
